...
Conductor::Conductor(const float& music_bpm, const float& first_beat_offset, const std::string& level_folder_path)
: music_(nullptr), sound_effect_(nullptr){
    
    level_folder_path_ = level_folder_path;
    music_bpm_ = music_bpm;
    seconds_per_beat_ = 60 / music_bpm_;
    music_position_ = 0;
